...
import com.ersystem.services.TicketSubmitter;
import com.fasterxml.jackson.databind.ObjectMapper;

public class SubmitTicketServlet extends DefaultServlet {
	private Logger log = Logger.getRootLogger();
	private TicketSubmitter submitter = new TicketSubmitter();
